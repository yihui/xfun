# Contributing to xfun

We welcome contributions to the **xfun** package. 
...
1.  [Fork](https://github.com/rstudio/xfun/fork) the repository and make your changes in a new branch specific to the PR. It is ok to edit a file in this repository using the `Edit` button on Github if the change is simple enough.
